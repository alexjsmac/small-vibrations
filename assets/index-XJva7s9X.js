import{a as j,n as Z,L as J,b as Ae,H as Oe,S as pe,O as xe,d as be,e as H,M as ye,B as Se,f as ee,c as U,A as Ce,h as Te,V as k}from"./three-vlqji54k.js";import{m as Re}from"./random-DL1jLgMw.js";import{O as te,r as oe}from"./onset-DHl140yf.js";import{P as ae}from"./poisson-BRMs42Pw.js";const m=.055,Le=16,_e=3.5,A=.6,Be=4,Fe=1.2,se=.05,Ie=.005,Ne=.008,De=.006,ie=.08,Ue=7,He=3*m,K=2.6,le=4,Pe=2,We=.5,Ge=1.1,V=[[0,0],[7,-5],[-5,7],[9,2],[-8,-3]],re=10,ze=5,Ve=.5*m,Ke=.22*m,Xe=1.6*m,$e=.5*m,Ye=1.5*m,ne=6,qe=3,Qe=1.6,je=.3,Ze=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
//# sourceMappingURL=index-XJva7s9X.js.map
