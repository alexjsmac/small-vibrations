import{a as L,n as V,N as se,b as ie,F as ke,H as ae,L as oe,O as Ae,V as g,S as k,d as Z,e as _,M as K,g as Ne,c as A,B as Be,f as N,o as H,Z as Ge,p as He,q as Xe,h as De,C as Me,A as Ye}from"./three-vlqji54k.js";import{m as _e}from"./random-DL1jLgMw.js";import{O as We,r as je}from"./onset-DHl140yf.js";const p=.48,Qe=512,$e=256,Ee=1024,Re=512,re=6,Ze=4,ne=4,Ke=3,le=2,qe=1,Je=180,et=60,tt=1/30,X=[2.4,2.8,3.2],Y=[.35,.45,.55],st=15,W=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
`;class lt{renderer;agentTexSize;trailTexSize;foodSlots;agentTargets;agentReadIndex=0;trailTargets;trailReadIndex=0;agentScene;trailScene;depositScene;orthoCam;agentQuad;agentMaterial;seedMaterial;trailQuad;trailMaterial;depositPoints;depositMaterial;speciesA;speciesB;params=null;speedMod=1;constructor(e,t,s,i){this.renderer=e,this.foodSlots=s,this.agentTexSize=t?Qe:$e,this.trailTexSize=t?Ee:Re;const l={type:!!e.extensions.get("EXT_color_buffer_float")?ke:ae,format:ie,minFilter:se,magFilter:se,wrapS:V,wrapT:V,depthBuffer:!1,stencilBuffer:!1};this.agentTargets=[new L(this.agentTexSize,this.agentTexSize,l),new L(this.agentTexSize,this.agentTexSize,l)];const u={type:ae,format:ie,minFilter:oe,magFilter:oe,wrapS:V,wrapT:V,depthBuffer:!1,stencilBuffer:!1};this.trailTargets=[new L(this.trailTexSize,this.trailTexSize,u),new L(this.trailTexSize,this.trailTexSize,u)],this.orthoCam=new Ae(-1,1,1,-1,0,1),this.speciesA=[new g,new g,new g],this.speciesB=[new g,new g,new g],this.agentScene=new k;const r=new Z(2,2);this.agentMaterial=new _({vertexShader:W,fragmentShader:it(s),depthTest:!1,depthWrite:!1,uniforms:{uAgentPrev:{value:null},uTrail:{value:null},uDt:{value:0},uSpeciesA:{value:this.speciesA},uSpeciesB:{value:this.speciesB},uFood:{value:i},uFoodPull:{value:0},uBurst:{value:new g(0,0,0,0)},uBurstSeed:{value:0}}}),this.seedMaterial=new _({vertexShader:W,fragmentShader:at,depthTest:!1,depthWrite:!1,uniforms:{uSeed:{value:0}}}),this.agentQuad=new K(r,this.agentMaterial),this.agentScene.add(this.agentQuad),this.trailScene=new k,this.trailMaterial=new _({vertexShader:W,fragmentShader:ot,depthTest:!1,depthWrite:!1,uniforms:{uTrailPrev:{value:null},uTexel:{value:new A(1/this.trailTexSize,1/this.trailTexSize)},uDecay:{value:new Ne(1,1,1)},uDecayFruit:{value:1},uFruitGain:{value:0}}}),this.trailQuad=new K(new Z(2,2),this.trailMaterial),this.trailScene.add(this.trailQuad);const a=this.agentTexSize,c=new Float32Array(a*a*2);let h=0;for(let m=0;m<a;m++)for(let f=0;f<a;f++)c[h++]=(f+.5)/a,c[h++]=(m+.5)/a;const v=new Be;v.setAttribute("aUv",new N(c,2)),v.setAttribute("position",new N(new Float32Array(a*a*3),3)),this.depositMaterial=new _({vertexShader:rt,fragmentShader:nt,depthTest:!1,depthWrite:!1,transparent:!0,blending:Xe,blendEquation:He,blendSrc:H,blendDst:H,blendSrcAlpha:Ge,blendDstAlpha:H,uniforms:{uAgentTex:{value:null},uSpeciesB:{value:this.speciesB},uDt:{value:0}}}),this.depositPoints=new De(v,this.depositMaterial),this.depositPoints.frustumCulled=!1,this.depositScene=new k,this.depositScene.add(this.depositPoints),this.clearTrail()}setActParams(e){this.params=e}setSpeedMod(e){this.speedMod=e}setBurst(e,t,s,i,o){this.agentMaterial.uniforms.uBurst.value.set(e,t,s,i),this.agentMaterial.uniforms.uBurstSeed.value=o}updateAgentUniforms(e,t){const s=e.speed*this.speedMod;this.speciesA[0].set(e.sensDistA,e.sensAngleA,X[0],s),this.speciesA[1].set(e.sensDistB,e.sensAngleB,X[1],s),this.speciesA[2].set(e.sensDistC,e.sensAngleC,X[2],s),this.speciesB[0].set(e.deposit,e.activeA,Y[0],0),this.speciesB[1].set(e.deposit,e.activeB,Y[1],0),this.speciesB[2].set(e.deposit,e.activeC,Y[2],0),this.agentMaterial.uniforms.uDt.value=t,this.agentMaterial.uniforms.uFoodPull.value=e.foodPull}updateTrailUniforms(e,t){const s=Math.exp(-e.decay*t);this.trailMaterial.uniforms.uDecay.value.set(s,s,s),this.trailMaterial.uniforms.uDecayFruit.value=Math.exp(-t/st),this.trailMaterial.uniforms.uFruitGain.value=e.fruitGain*t}step(e,t){const s=this.params;if(!s||t<=0)return;const i=e/t,o=this.renderer.getRenderTarget(),n=this.renderer.autoClear;for(let l=0;l<t;l++){this.updateAgentUniforms(s,i);const u=this.agentTargets[this.agentReadIndex],r=this.agentTargets[1-this.agentReadIndex];this.agentMaterial.uniforms.uAgentPrev.value=u.texture,this.agentMaterial.uniforms.uTrail.value=this.trailTargets[this.trailReadIndex].texture,this.renderer.setRenderTarget(r),this.renderer.autoClear=!0,this.renderer.render(this.agentScene,this.orthoCam),this.agentReadIndex=1-this.agentReadIndex,this.updateTrailUniforms(s,i);const a=this.trailTargets[this.trailReadIndex],c=this.trailTargets[1-this.trailReadIndex];this.trailMaterial.uniforms.uTrailPrev.value=a.texture,this.renderer.setRenderTarget(c),this.renderer.autoClear=!0,this.renderer.render(this.trailScene,this.orthoCam),this.depositMaterial.uniforms.uAgentTex.value=this.agentTargets[this.agentReadIndex].texture,this.depositMaterial.uniforms.uDt.value=i,this.renderer.autoClear=!1,this.renderer.render(this.depositScene,this.orthoCam),this.trailReadIndex=1-this.trailReadIndex}this.renderer.autoClear=n,this.renderer.setRenderTarget(o??null)}seedAgents(e){const t=e();this.seedMaterial.uniforms.uSeed.value=t;const s=this.renderer.getRenderTarget();this.agentQuad.material=this.seedMaterial;for(const i of this.agentTargets)this.renderer.setRenderTarget(i),this.renderer.render(this.agentScene,this.orthoCam);this.renderer.setRenderTarget(s??null),this.agentQuad.material=this.agentMaterial}clearTrail(){const e=this.renderer.getRenderTarget(),t=new Me;this.renderer.getClearColor(t);const s=this.renderer.getClearAlpha();this.renderer.setClearColor(0,0);for(const i of this.trailTargets)this.renderer.setRenderTarget(i),this.renderer.clear(!0,!1,!1);this.renderer.setClearColor(t,s),this.renderer.setRenderTarget(e??null)}get trailTexture(){return this.trailTargets[this.trailReadIndex].texture}dispose(){this.agentTargets[0].dispose(),this.agentTargets[1].dispose(),this.trailTargets[0].dispose(),this.trailTargets[1].dispose(),this.agentMaterial.dispose(),this.seedMaterial.dispose(),this.trailMaterial.dispose(),this.depositMaterial.dispose(),this.agentQuad.geometry.dispose(),this.trailQuad.geometry.dispose(),this.depositPoints.geometry.dispose()}}const ht=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = vec4(position.xy, 0.0, 1.0);
}
`;function ut(d,e,t,s){return`
precision highp float;
varying vec2 vUv;
...
`}const ct=4e3,dt=1200;class vt{constructor(e,t,s){this.renderer=s;const i=_e(e^93360613),o=Math.min(t.particleBudget,t.level==="full"?ct:dt),n=new Float32Array(o*3),l=new Float32Array(o);for(let u=0;u<o;u++)n[u*3+0]=(i()*2-1)*.62,n[u*3+1]=(i()*2-1)*.62,n[u*3+2]=(i()*2-1)*.4,l[u]=i();this.geometry=new Be,this.geometry.setAttribute("position",new N(n,3)),this.geometry.setAttribute("aSeed",new N(l,1)),this.uniforms={uFlowTime:{value:0},uTurbulence:{value:.6},uFlowAmount:{value:.5},uDensity:{value:1},uBrightness:{value:.65},uHigh:{value:0},uBass:{value:0},uScale:{value:90},uSeedShift:{value:i()*100},uFlash:{value:0},uZoom:{value:1},uCover:{value:new A(1,1)},uPan:{value:new A(0,0)}},this.material=new _({uniforms:this.uniforms,transparent:!0,depthTest:!1,depthWrite:!1,blending:Ye,vertexShader:`
        precision highp float;
      ...
      `}),this.object=new De(this.geometry,this.material),this.object.frustumCulled=!1}object;material;geometry;uniforms;update(e,t,s,i,o,n,l=0){const u=s.params,r=this.uniforms;r.uFlowTime.value+=e*.5,r.uDensity.value=u.sporeDensity,r.uHigh.value=t.high,r.uBass.value=t.bass,r.uFlash.value=l,r.uZoom.value=i,r.uCover.value.copy(o),r.uPan.value.copy(n),r.uScale.value=this.renderer.domElement.height*.1}dispose(){this.geometry.dispose(),this.material.dispose()}}const w=[0,54,106,130,154,178,234,251.238],U=[{name:"spores",activeA:.35,activeB:0,activeC:0,sensDistA:.035,sensDistB:.03,sensDistC:.03,sensAngleA:.5,sensAngleB:.4,sensAngleC:.4,speed:.05,deposit:.15,decay:.25,fruitGain:.05,fruitGlow:.1,sporeDensity:1,burstRate:2,throb:.2,shimmer:.15,sat:.9,palMix:.1,zoom:1,foodPull:.3,bubbles:0},{name:"first-bloom",activeA:.8,activeB:.1,activeC:0,sensDistA:.04,sensDistB:.03,sensDistC:.03,sensAngleA:.55,sensAngleB:.4,sensAngleC:.4,speed:.09,deposit:.45,decay:.2,fruitGain:.25,fruitGlow:.4,sporeDensity:.5,burstRate:10,throb:.6,shimmer:.3,sat:1,palMix:.2,zoom:1,foodPull:.4,bubbles:0},{name:"rot",activeA:.55,activeB:.1,activeC:0,sensDistA:.04,sensDistB:.03,sensDistC:.03,sensAngleA:.5,sensAngleB:.4,sensAngleC:.4,speed:.06,deposit:.15,decay:.55,fruitGain:.1,fruitGlow:.2,sporeDensity:.3,burstRate:1.5,throb:.25,shimmer:.15,sat:.45,palMix:.55,zoom:1,foodPull:.2,bubbles:0},{name:"stirring",activeA:.5,activeB:.7,activeC:0,sensDistA:.04,sensDistB:.07,sensDistC:.03,sensAngleA:.5,sensAngleB:.9,sensAngleC:.4,speed:.08,deposit:.3,decay:.3,fruitGain:.15,fruitGlow:.25,sporeDensity:.35,burstRate:4,throb:.35,shimmer:.25,sat:.7,palMix:.35,zoom:1,foodPull:.35,bubbles:0},{name:"convergence",activeA:.7,activeB:.75,activeC:.4,sensDistA:.04,sensDistB:.07,sensDistC:.025,sensAngleA:.5,sensAngleB:.9,sensAngleC:.3,speed:.09,deposit:.4,decay:.25,fruitGain:.2,fruitGlow:.3,sporeDensity:.3,burstRate:6,throb:.4,shimmer:.3,sat:.55,palMix:.3,zoom:1,foodPull:.45,bubbles:0},{name:"full-biosphere",activeA:.95,activeB:.9,activeC:.6,sensDistA:.045,sensDistB:.075,sensDistC:.028,sensAngleA:.55,sensAngleB:.95,sensAngleC:.32,speed:.11,deposit:.55,decay:.2,fruitGain:.3,fruitGlow:.55,sporeDensity:.6,burstRate:16,throb:.85,shimmer:.6,sat:1,palMix:.15,zoom:.72,foodPull:.5,bubbles:1},{name:"exhale",activeA:.15,activeB:.05,activeC:.02,sensDistA:.035,sensDistB:.03,sensDistC:.025,sensAngleA:.5,sensAngleB:.4,sensAngleC:.3,speed:.04,deposit:.08,decay:.7,fruitGain:.05,fruitGlow:.15,sporeDensity:.9,burstRate:1,throb:.15,shimmer:.1,sat:.6,palMix:.1,zoom:1,foodPull:.2,bubbles:0}],M=[[0,.1],[40,.25],[53.8,.3],[54.3,.55],[90,.5],[106,.35],[130,.4],[154,.55],[177.8,.62],[178.3,.95],[210,1],[234,.5],[251.238,.12]],he={energy:0};function ft(d){const e=Math.min(Math.max(d,0),M[M.length-1][0]);let t=0;for(;t<M.length-2&&e>=M[t+1][0];)t++;const s=M[t],i=M[t+1],o=Math.min(1,Math.max(0,(e-s[0])/Math.max(.001,i[0]-s[0])));return he.energy=s[1]+(i[1]-s[1])*o,he}const mt=6;function pt(d){const e=Math.min(1,Math.max(0,d));return e*e*(3-2*e)}function gt(d,e,t){if(t<=0)return d;if(t>=1)return e;const s={...d,name:t<.5?d.name:e.name};for(const i of Object.keys(d)){const o=d[i],n=e[i];typeof o=="number"&&typeof n=="number"&&(s[i]=o+(n-o)*t)}return s}function bt(d){const e=w[w.length-1],t=Math.min(Math.max(d,0),e-.001);let s=0;for(;s<U.length-1&&t>=w[s+1];)s++;const i=w[s],o=w[s+1]??e,n=Math.min(1,Math.max(0,(t-i)/Math.max(.001,o-i))),l=s<U.length-1,u=o-t,r=l?pt(1-Math.min(1,u/mt)):0,a=U[s],c=l?U[s+1]:a;return{params:gt(a,c,r),actIndex:s,localT:n,blend:r}}const xt=.25,yt=.08,St=.06,ue=1.1,Tt=.4,wt=.25,At=1.1,Bt=1.6,Dt=.5,Mt=.18,ce=.05,de=.12,_t=.09,Et=.45,Rt=1.2,Ct=50,ve=.06,fe=6,Ut=20,me=5e-4,Ft=10,z=1.5,j=.16,pe=14,It=10,R=.03,ge=.09,Pt=.16,Lt=2.5,Vt=.07,be=2.5,zt=.7,Ot=.6,kt=.55,xe=.015,Nt=7,Gt=10,ye=.1,Se=.08,Te=.14,Q=1.1,Ue=U.findIndex(d=>d.name==="full-biosphere"),O=w[Ue],Ht=w[Ue+1],$=.03,we=.12,Xt=.1,Yt=3;function C(d){const e=Math.sin(d*12.9898)*43758.5453;return e-Math.floor(e)}class Wt{renderer;scene;camera;sim;dishQuad;dishMaterial;spores;rand;soloDish=!0;soloSpores=!0;forceBurstAlways=!1;forceFoodAlways=!1;full=!0;foodSlotCount=re;burstVisSlotCount=ne;stepsPerFrame=le;cover=new A(1,1);pan=new A(0,0);bassE=0;midE=0;highE=0;bassOnset=new We({refRate:xt,relMargin:yt,absFloor:St,cooldown:ue});burstOnsetCooldown=0;flash=0;burstTimeToNext=0;burstActive=!1;burstTimeLeft=0;foodTimeToNext=0;foodSlots=[];foodValues;burstVisSlots=[];burstVisValues;bubbleSlotCount=pe;bubbleSlots=[];bubbleValues;bubbleTimeToNext=0;motherX=.5;motherY=.5;motherVX=0;motherVY=0;motherR=p;motherUniformVec=new g(.5,.5,p,0);firstUpdate=!0;lastDt=0;lastSongTime=-1;held=!1;dragDx=0;dragDy=0;velX=0;velY=0;init(e){const{renderer:t,seed:s,quality:i}=e;this.renderer=t,this.rand=_e(s^2969960014);const o=new URLSearchParams(location.search),n=o.get("solo");this.soloDish=!n||n==="veins"||n==="fruit",this.soloSpores=!n||n==="spores",this.forceBurstAlways=o.get("burst")==="always",this.forceFoodAlways=o.get("food")==="always";const l=n==="veins"?1:n==="fruit"?2:0;this.full=i.level==="full",this.foodSlotCount=this.full?re:Ze,this.burstVisSlotCount=this.full?ne:Ke,this.stepsPerFrame=this.full?le:qe;for(let h=0;h<this.foodSlotCount;h++)this.foodSlots.push({age:0,active:!1});this.foodValues=[];for(let h=0;h<this.foodSlotCount;h++)this.foodValues.push(new g(0,0,ve,0));for(let h=0;h<this.burstVisSlotCount;h++)this.burstVisSlots.push({age:0,active:!1});this.burstVisValues=[];for(let h=0;h<this.burstVisSlotCount;h++)this.burstVisValues.push(new g(0,0,0,0));this.bubbleSlotCount=this.full?pe:It;for(let h=0;h<this.bubbleSlotCount;h++)this.bubbleSlots.push({active:!1,growTargetR:0,vx:0,vy:0,age:0});this.bubbleValues=[];for(let h=0;h<this.bubbleSlotCount;h++)this.bubbleValues.push(new g(0,0,0,0));this.scene=new k,this.camera=new Ae(-1,1,1,-1,0,1),n&&(this.scene.background=new Me(3813440)),this.sim=new lt(t,this.full,this.foodSlotCount,this.foodValues);const u=this.full?Ee:Re;this.dishMaterial=new _({vertexShader:ht,fragmentShader:ut(this.full,this.foodSlotCount,this.burstVisSlotCount,this.bubbleSlotCount),depthTest:!1,depthWrite:!1,uniforms:{uTrail:{value:null},uTrailTexel:{value:new A(1/u,1/u)},uCover:{value:new A(1,1)},uPan:{value:this.pan},uZoom:{value:1},uTime:{value:0},uBass:{value:0},uHigh:{value:0},uFlash:{value:0},uThrob:{value:0},uShimmer:{value:0},uSat:{value:1},uPalMix:{value:0},uEnergy:{value:0},uFruitGlow:{value:0},uFood:{value:this.foodValues},uBurstVis:{value:this.burstVisValues},uBubble:{value:this.bubbleValues},uMother:{value:this.motherUniformVec},uSoloMode:{value:l}}}),this.dishQuad=new K(new Z(2,2),this.dishMaterial),this.soloDish&&this.scene.add(this.dishQuad),this.spores=new vt(s,i,t),this.soloSpores&&this.scene.add(this.spores.object);const r=t.domElement,a=r.clientWidth||1,c=r.clientHeight||1;this.resize(a,c)}kickFlash(e){this.flash=Math.min(Bt,this.flash+e)}randomDishPoint(){const e=p*Math.sqrt(this.rand()),t=this.rand()*Math.PI*2;return[.5+Math.cos(t)*e,.5+Math.sin(t)*e]}activateBurstVis(e,t,s){let i=this.burstVisSlots.findIndex(n=>!n.active);i<0&&(i=0);const o=this.burstVisSlots[i];o.active=!0,o.age=0,this.burstVisValues[i].set(e,t,0,s)}updateBurstVisAges(e){for(let t=0;t<this.burstVisSlots.length;t++){const s=this.burstVisSlots[t];s.active&&(s.age+=e,s.age>=Rt?(s.active=!1,this.burstVisValues[t].w=0):this.burstVisValues[t].z=s.age)}}triggerBurst(e,t,s,i){this.burstActive=!0,this.burstTimeLeft=Mt,this.sim.setBurst(e,t,s,i,this.rand()),this.activateBurstVis(e,t,1)}updateBurstActive(e){this.burstActive&&(this.burstTimeLeft-=e,this.burstTimeLeft<=0&&(this.burstActive=!1,this.sim.setBurst(0,0,0,0,0)))}scheduleBursts(e,t){const s=Math.max(0,t)/60;if(!(s<=0))for(this.burstTimeToNext-=e;this.burstTimeToNext<=0;){const[i,o]=this.randomDishPoint();this.triggerBurst(i,o,ce,de),this.kickFlash(wt);const n=Math.max(1e-6,this.rand());this.burstTimeToNext+=-Math.log(n)/s}}scriptedMassBurst(){this.triggerBurst(.5,.5,_t,Et);for(let e=0;e<3;e++){const[t,s]=this.randomDishPoint();this.activateBurstVis(t,s,1)}this.kickFlash(At)}activateFood(e,t){let s=this.foodSlots.findIndex(o=>!o.active);s<0&&(s=0);const i=this.foodSlots[s];i.active=!0,i.age=0,this.foodValues[s].set(e,t,ve,1)}updateFoodAges(e){for(let t=0;t<this.foodSlots.length;t++){const s=this.foodSlots[t];s.active&&(s.age+=e,s.age>=fe?(s.active=!1,this.foodValues[t].w=0):this.foodValues[t].w=1-s.age/fe)}}scheduleFood(e,t){const s=Math.max(0,t)/60;if(!(s<=0))for(this.foodTimeToNext-=e;this.foodTimeToNext<=0;){const[i,o]=this.randomDishPoint();this.activateFood(i,o);const n=Math.max(1e-6,this.rand());this.foodTimeToNext+=-Math.log(n)/s}}trySpawnBubble(){let e=-1;for(let l=0;l<this.bubbleSlots.length;l++)if(!this.bubbleSlots[l].active){e=l;break}if(e<0)return;let t=-1;if(this.rand()<.5){let l=0;for(let u=0;u<this.bubbleSlots.length;u++)this.bubbleSlots[u].active&&this.bubbleValues[u].z>Vt&&(l++,this.rand()<1/l&&(t=u))}const s=this.rand()*Math.PI*2;let i,o;if(t>=0){const l=this.bubbleValues[t];i=l.x+Math.cos(s)*(l.z+.5*R),o=l.y+Math.sin(s)*(l.z+.5*R)}else i=this.motherX+Math.cos(s)*(this.motherR+.5*R),o=this.motherY+Math.sin(s)*(this.motherR+.5*R);const n=this.bubbleSlots[e];n.active=!0,n.age=0,n.growTargetR=ge+this.rand()*(Pt-ge),n.vx=0,n.vy=0,this.bubbleValues[e].set(i,o,R,this.rand()),this.activateBurstVis(i,o,kt)}scheduleBubbleSpawns(e,t,s){if(t.bubbles<=.001)return;const i=Math.min(1,Math.max(0,(s-O)/Math.max(.001,Ht-O))),n=1/(be+(zt-be)*Math.min(1,i/Ot));for(this.bubbleTimeToNext-=e;this.bubbleTimeToNext<=0;){this.trySpawnBubble();const l=Math.max(1e-6,this.rand());this.bubbleTimeToNext+=-Math.log(l)/n}}updateBubbles(e,t,s){const i=this.bubbleSlots,o=this.bubbleValues,n=i.length,l=1-Math.exp(-e/Lt);for(let r=0;r<n;r++){const a=i[r];if(!a.active)continue;a.age+=e;const c=o[r],h=a.growTargetR*t.bubbles;c.z+=(h-c.z)*l,c.z<.01&&a.age>.1&&(a.active=!1,c.set(0,0,0,0))}for(let r=0;r<n;r++){if(!i[r].active)continue;const a=o[r];for(let b=r+1;b<n;b++){if(!i[b].active)continue;const x=o[b],T=x.x-a.x,E=x.y-a.y,I=Math.max(1e-5,Math.hypot(T,E)),q=a.z+x.z+xe;if(I>=q)continue;const J=T/I,ee=E/I,Oe=q-I,G=a.z*a.z/(a.z*a.z+x.z*x.z+1e-6),te=1-G,P=Oe*Nt*e;i[r].vx-=J*P*te,i[r].vy-=ee*P*te,i[b].vx+=J*P*G,i[b].vy+=ee*P*G}const c=a.x-this.motherX,h=a.y-this.motherY,v=Math.max(1e-5,Math.hypot(c,h)),m=this.motherR+a.z+xe;if(v<m){const b=c/v,x=h/v,T=(m-v)*Gt*e;i[r].vx+=b*T,i[r].vy+=x*T;const E=a.z*a.z/(this.motherR*this.motherR);this.motherVX-=b*T*E,this.motherVY-=x*T*E}const f=a.x-this.motherX,y=a.y-this.motherY,F=Math.max(1e-5,Math.hypot(f,y)),S=C(a.w*3.7+1.1)<.5?1:-1,B=-y/F*S,D=f/F*S;i[r].vx+=B*ye*e,i[r].vy+=D*ye*e;const Fe=.5+C(a.w*5.21+2.3)*.8,Ie=.5+C(a.w*7.77+9.4)*.8,Pe=C(a.w*3.14+6.6)*Math.PI*2,Le=C(a.w*4.44+8.8)*Math.PI*2,Ve=Math.sin(s*Fe+Pe),ze=Math.cos(s*Ie+Le);i[r].vx+=Ve*Se*e,i[r].vy+=ze*Se*e}const u=Math.exp(-2.2*e);for(let r=0;r<n;r++){const a=i[r];if(!a.active)continue;const c=o[r];c.x+=a.vx*e,c.y+=a.vy*e,a.vx*=u,a.vy*=u;const h=Math.hypot(a.vx,a.vy);if(h>Te){const y=Te/h;a.vx*=y,a.vy*=y}const v=c.x-.5,m=c.y-.5,f=Math.hypot(v,m);f>Q&&(c.x=.5+v/f*Q,c.y=.5+m/f*Q,a.vx=0,a.vy=0)}}updateMother(e){let t=0,s=0,i=0,o=0;const n=this.bubbleSlots,l=this.bubbleValues;for(let S=0;S<n.length;S++){if(!n[S].active)continue;const B=l[S],D=B.z*B.z;t+=D,s+=B.x*D,i+=B.y*D,o+=D}let u=.5,r=.5;o>1e-6&&(u=.5-we*(s/o-.5),r=.5-we*(i/o-.5));const a=this.motherX-u,c=this.motherY-r;this.motherVX+=-3*a*e,this.motherVY+=-3*c*e,this.motherX+=this.motherVX*e,this.motherY+=this.motherVY*e;const h=Math.exp(-2.5*e);this.motherVX*=h,this.motherVY*=h;const v=this.motherX-.5,m=this.motherY-.5,f=Math.hypot(v,m);f>$&&(this.motherX=.5+v/f*$,this.motherY=.5+m/f*$,this.motherVX=0,this.motherVY=0),t/=p*p;const y=p*(1-Xt*Math.min(1,t)),F=1-Math.exp(-e/Yt);this.motherR+=(y-this.motherR)*F,this.motherUniformVec.set(this.motherX,this.motherY,this.motherR,0)}resetBubbles(){for(let e=0;e<this.bubbleSlots.length;e++){const t=this.bubbleSlots[e];t.active=!1,t.vx=0,t.vy=0,t.age=0,this.bubbleValues[e].set(0,0,0,0)}this.bubbleTimeToNext=0,this.motherX=.5,this.motherY=.5,this.motherVX=0,this.motherVY=0,this.motherR=p,this.motherUniformVec.set(.5,.5,p,0)}warmup(e,t,s){s&&this.sim.seedAgents(this.rand),this.sim.setActParams(e),this.sim.step(tt*t,t)}update(e,t){const s=bt(t.time),i=s.params;if(this.lastDt=e,this.firstUpdate&&(this.firstUpdate=!1,this.warmup(i,Je,!0),i.bubbles>.001&&t.time>O))for(let h=O;h<t.time;h+=.25)this.scheduleBubbleSpawns(.25,i,h),this.updateBubbles(.25,i,h),this.updateMother(.25),this.updateBurstVisAges(.25);this.lastSongTime>=0&&t.time<this.lastSongTime-10&&(this.sim.clearTrail(),this.warmup(i,et,!0),this.resetBubbles()),this.lastSongTime>=0&&t.time-this.lastSongTime>=0&&t.time-this.lastSongTime<.5&&(this.lastSongTime<54&&t.time>=54&&this.scriptedMassBurst(),this.lastSongTime<178&&t.time>=178&&this.scriptedMassBurst()),this.lastSongTime=t.time;const o=Math.min(1,e*8),n=this.bassE;if(this.bassE+=(t.bass-this.bassE)*o,this.midE+=(t.mid-this.midE)*o,this.highE+=(t.high-this.highE)*o,this.burstOnsetCooldown-=e,this.bassOnset.update(e,this.bassE,n)){if(this.burstOnsetCooldown<=0){const[c,h]=this.randomDishPoint();this.triggerBurst(c,h,ce,de),this.burstOnsetCooldown=je(ue,i.burstRate)}this.kickFlash(Tt),i.bubbles>.001&&this.trySpawnBubble()}this.scheduleBursts(e,this.forceBurstAlways?Ct:i.burstRate),this.updateBurstActive(e),this.updateBurstVisAges(e),this.scheduleFood(e,this.forceFoodAlways?Ut:0),this.updateFoodAges(e),this.scheduleBubbleSpawns(e,i,t.time),this.updateBubbles(e,i,t.time),this.updateMother(e),this.flash*=Math.exp(-3.2*e),this.sim.setSpeedMod(1+this.midE*Dt),this.sim.setActParams(i);const l=this.dishMaterial.uniforms;l.uTime.value+=e,l.uBass.value=this.bassE,l.uHigh.value=this.highE,l.uFlash.value=this.flash,l.uThrob.value=i.throb,l.uShimmer.value=i.shimmer,l.uSat.value=i.sat,l.uPalMix.value=i.palMix,l.uFruitGlow.value=i.fruitGlow,l.uEnergy.value=ft(t.time).energy;const u=i.zoom;l.uZoom.value=u;const r=this.cover;if(this.held){if(e>1e-5){const c=Math.min(1,e*Ft),h=Math.min(z,Math.max(-z,this.dragDx/e)),v=Math.min(z,Math.max(-z,this.dragDy/e));this.velX+=(h-this.velX)*c,this.velY+=(v-this.velY)*c}this.dragDx=0,this.dragDy=0}else if(this.velX!==0||this.velY!==0){this.pan.x+=this.velX*r.x/u*e,this.pan.y+=this.velY*r.y/u*e;const c=Math.exp(-2.5*e);this.velX*=c,this.velY*=c,Math.abs(this.velX)<me&&(this.velX=0),Math.abs(this.velY)<me&&(this.velY=0)}const a=Math.hypot(this.pan.x,this.pan.y);a>j&&(this.pan.x*=j/a,this.pan.y*=j/a,this.velX=0,this.velY=0),this.spores.update(e,t,s,u,r,this.pan,this.flash)}pointer(e){const t=this.dishMaterial.uniforms.uZoom.value,s=this.cover;if(e.type==="down"){this.held=!0,this.dragDx=0,this.dragDy=0,this.velX=0,this.velY=0;const i=(e.x-.5)*s.x/t+.5+this.pan.x,o=(e.y-.5)*s.y/t+.5+this.pan.y;this.activateFood(i,o);return}if(e.type==="move"){if(!this.held)return;this.pan.x+=e.dx*s.x/t,this.pan.y+=e.dy*s.y/t,this.dragDx+=e.dx,this.dragDy+=e.dy;return}if(e.type==="up"){this.held=!1;return}this.held=!1,this.velX=0,this.velY=0,this.dragDx=0,this.dragDy=0}render(){this.sim.step(this.lastDt,this.stepsPerFrame),this.dishMaterial.uniforms.uTrail.value=this.sim.trailTexture,this.renderer.setRenderTarget(null),this.renderer.render(this.scene,this.camera)}resize(e,t){if(!this.dishMaterial||e<=0||t<=0)return;const s=Math.min(3.5,Math.max(.28,e/t));s>=1?this.cover.set(s,1):this.cover.set(1,1/s),this.dishMaterial.uniforms.uCover.value.copy(this.cover)}dispose(){this.sim.dispose(),this.dishMaterial.dispose(),this.dishQuad.geometry.dispose(),this.spores.dispose(),this.renderer.setRenderTarget(null)}}const jt={default:()=>new Wt},Kt=jt.default;export{Kt as default};
//# sourceMappingURL=index-BPp8KuoJ.js.map
