import{a as Q,n as j,L as Z,b as Le,H as _e,S as de,O as fe,d as ve,e as U,M as ge,B as Me,f as J,c as D,A as ke,h as Ee,V as _}from"./three-vlqji54k.js";import{m as we}from"./random-DL1jLgMw.js";const m=.055,pe=16,xe=3.5,k=.6,Ae=4,Se=1.2,ee=.05,Oe=.005,Ce=.008,Te=.006,te=.08,Be=7,Fe=3*m,V=2.6,oe=4,Ne=2,Ie=.5,He=1.1,z=[[0,0],[7,-5],[-5,7],[9,2],[-8,-3]],ae=10,De=5,Ue=.5*m,Pe=.22*m,We=1.6*m,Ge=.5*m,ze=1.5*m,se=6,Ve=3,Ke=1.6,Xe=.3,$e=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
//# sourceMappingURL=index-CiUpgJXc.js.map
