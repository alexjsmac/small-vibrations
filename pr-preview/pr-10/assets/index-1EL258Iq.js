import{a as E,R,L as I,b as Z,H as J,V as g,c as x,S as K,O as Y,d as X,e as y,M as $}from"./three-vlqji54k.js";import{m as Q}from"./random-DL1jLgMw.js";const ee=512,te=256,P=2,ae=1,_=6,ie=4,b=4,se=240,oe=60,k=1/30,O=256,le=.05,C=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
`}const u=[0,56,128,172,232,316,336.998],m=[{name:"thriving-field",vitalityTarget:.95,churn:.9,scanRate:0,scanDrain:0,misProb:0,classifyPressure:0,waveRate:0,gridStrength:0,gridFine:0,glyphDensity:.85,chatterRate:1.2,machineFrac:0,machineOrder:0,classifiedFloor:0,commFreq:6,zoom:1.18,survivorFocus:0,hueSat:1,warmth:.55,rustMix:.05,inkPersist:0,vignette:.3,motes:.15,groundLight:.9},{name:"first-scans",vitalityTarget:.85,churn:.8,scanRate:5,scanDrain:.5,misProb:.3,classifyPressure:0,waveRate:0,gridStrength:.18,gridFine:.25,glyphDensity:.8,chatterRate:1,machineFrac:.08,machineOrder:.05,classifiedFloor:.06,commFreq:6,zoom:1.05,survivorFocus:0,hueSat:.92,warmth:.5,rustMix:.15,inkPersist:.5,vignette:.32,motes:.08,groundLight:.9},{name:"accelerating-catalogue",vitalityTarget:.7,churn:.75,scanRate:16,scanDrain:.7,misProb:.15,classifyPressure:0,waveRate:0,gridStrength:.42,gridFine:.5,glyphDensity:.7,chatterRate:.9,machineFrac:.3,machineOrder:.25,classifiedFloor:.28,commFreq:6,zoom:.98,survivorFocus:0,hueSat:.8,warmth:.45,rustMix:.35,inkPersist:.8,vignette:.35,motes:.05,groundLight:.9},{name:"last-unclassified",vitalityTarget:.9,churn:.6,scanRate:1.5,scanDrain:.4,misProb:0,classifyPressure:0,waveRate:0,gridStrength:.1,gridFine:.15,glyphDensity:.9,chatterRate:.7,machineFrac:.35,machineOrder:.3,classifiedFloor:.34,commFreq:6,zoom:2.9,survivorFocus:1,hueSat:.85,warmth:.5,rustMix:.3,inkPersist:.5,vignette:.5,motes:.05,groundLight:.9},{name:"total-classification",vitalityTarget:.25,churn:.5,scanRate:34,scanDrain:1,misProb:0,classifyPressure:.35,waveRate:10,gridStrength:1,gridFine:1,glyphDensity:.55,chatterRate:1.4,machineFrac:.9,machineOrder:.85,classifiedFloor:.9,commFreq:6,zoom:.82,survivorFocus:0,hueSat:.4,warmth:.35,rustMix:.62,inkPersist:1,vignette:.38,motes:.02,groundLight:.9},{name:"residue",vitalityTarget:.1,churn:.25,scanRate:0,scanDrain:0,misProb:0,classifyPressure:0,waveRate:0,gridStrength:.06,gridFine:0,glyphDensity:.08,chatterRate:.3,machineFrac:1,machineOrder:1,classifiedFloor:.93,commFreq:6,zoom:1.15,survivorFocus:0,hueSat:.2,warmth:.3,rustMix:.45,inkPersist:.35,vignette:.45,motes:.5,groundLight:1}],p=[[0,.22],[30,.34],[36,.28],[54,.3],[56,.36],[100,.45],[126,.5],[128,.58],[167.8,.68],[168.3,.78],[171,.74],[174,.42],[200,.38],[228,.5],[231.7,.55],[232.2,.96],[246,1],[300,.82],[315.6,.7],[316.4,.18],[330,.08],[336.998,.04]],L={energy:0};function fe(c){const e=Math.min(Math.max(c,0),p[p.length-1][0]);let i=0;for(;i<p.length-2&&e>=p[i+1][0];)i++;const t=p[i],a=p[i+1],s=Math.min(1,Math.max(0,(e-t[0])/Math.max(.001,a[0]-t[0])));return L.energy=t[1]+(a[1]-t[1])*s,L}const de=6;function ve(c){const e=Math.min(1,Math.max(0,c));return e*e*(3-2*e)}function pe(c,e,i){if(i<=0)return c;if(i>=1)return e;const t={...c,name:i<.5?c.name:e.name};for(const a of Object.keys(c)){const s=c[a],r=e[a];typeof s=="number"&&typeof r=="number"&&(t[a]=s+(r-s)*i)}return t}function ge(c){const e=u[u.length-1],i=Math.min(Math.max(c,0),e-.001);let t=0;for(;t<m.length-1&&i>=u[t+1];)t++;const a=u[t],s=u[t+1]??e,r=Math.min(1,Math.max(0,(i-a)/Math.max(.001,s-a))),o=t<m.length-1,h=s-i,l=o?ve(1-Math.min(1,h/de)):0,v=m[t],f=o?m[t+1]:v;return{params:pe(v,f,l),actIndex:t,localT:r,blend:l}}const Se=.12,we=.5,xe=.09,ye=.22,H=.35,be=.18,M=1.2,ke=1.6,Ce=.75,Me=1.2,Te=.5,G=4,Fe=1.2,Ae=2,De=1,Ee=4,Re=2,Ie=.5,T=1.4,Pe=2.2,_e=.42,Oe=.12,Le=.012,He=1.2,F=1.6,Ge=.8,Ne=1,N=168,U=232,z=316,V=330,Ue=.6,ze=36,W=1.3,Ve=8,q=.45,We=.015,qe=.22,B=5e-4,Be=10,w=1.5,A=.6,Ke=.35,Ye=.05,Xe=1;class $e{renderer;scene;camera;field;quad;material;rand;forceScanAlways=!1;forceMisAlways=!1;forceWaveAlways=!1;forceFlickerAlways=!1;forceSparkAlways=!1;pinnedClassified=null;full=!0;stampSlotCount=_;stepsPerFrame=P;cover=new x(1,1);pan=new x(0,0);bassE=0;midE=0;highE=0;bassSlowE=0;highSlowE=0;onsetCooldown=0;highOnsetCooldown=0;flash=0;spark=0;sparkSeed=0;sparkDebugTimer=0;scanSlots=[];scanA=[];scanB=[];scanTimeToNext=0;scanDebugTimer=0;pendingBurst=0;burstTimer=0;waveActive=!1;waveAge=0;waveCx=.5;waveCy=.5;waveTimeToNext=0;waveDebugTimer=0;rippleSlots=[];rippleValues=[];pokeSlots=[];classified=0;gridSlam=0;flickerEnv=0;breathPhase=0;firstUpdate=!0;lastDt=0;lastSongTime=-1;held=!1;dragDx=0;dragDy=0;velX=0;velY=0;init(e){const{renderer:i,seed:t,quality:a}=e;this.renderer=i,this.rand=Q(t^2999220761);const s=new URLSearchParams(location.search),r=s.get("solo"),o=r==="field"?1:r==="patch"?2:r==="glyphs"?3:r==="machine"?4:0;this.forceScanAlways=s.get("scan")==="always",this.forceMisAlways=s.get("mis")==="always",this.forceWaveAlways=s.get("wave")==="always",this.forceFlickerAlways=s.get("flicker")==="always",this.forceSparkAlways=s.get("spark")==="always";const h=s.get("classified");if(h!==null){const n=parseFloat(h);Number.isNaN(n)||(this.pinnedClassified=Math.min(1,Math.max(0,n)))}this.full=a.level==="full",this.stampSlotCount=this.full?_:ie;const l=this.full?Ae:De,v=this.full?Ee:Re;this.stepsPerFrame=this.full?P:ae;for(let n=0;n<this.stampSlotCount;n++)this.scanSlots.push({age:0,active:!1,mislabel:!1}),this.scanA.push(new g(0,0,0,0)),this.scanB.push(new g(0,0,0,0));for(let n=0;n<G;n++)this.rippleSlots.push({age:0,active:!1}),this.rippleValues.push(new g(0,0,0,0));for(let n=0;n<b;n++)this.pokeSlots.push({age:0,active:!1});this.breathPhase=this.rand()*Math.PI*2,this.scene=new K,this.camera=new Y(-1,1,1,-1,0,1),this.field=new he(i,this.full,this.stampSlotCount),this.material=new y({vertexShader:me,fragmentShader:ue(G,this.stampSlotCount,l,v),depthTest:!1,depthWrite:!1,uniforms:{uField:{value:null},uTime:{value:0},uCover:{value:new x(1,1)},uZoom:{value:1},uPan:{value:this.pan},uCommFreq:{value:6},uEnergy:{value:0},uFlash:{value:0},uSparkle:{value:0},uGlyphKick:{value:0},uGlyphSeed:{value:0},uChurn:{value:0},uChatter:{value:0},uGlyphDensity:{value:0},uMachineFrac:{value:0},uMachineOrder:{value:0},uClassified:{value:0},uGridStrength:{value:0},uGridFine:{value:0},uGridSlam:{value:0},uHueSat:{value:0},uWarmth:{value:0},uRustMix:{value:0},uInkPersist:{value:0},uVignette:{value:0},uMotes:{value:0},uGroundLight:{value:0},uSurvivorFocus:{value:0},uDesat:{value:0},uSoloMode:{value:o},uFlicker:{value:0},uScanA:{value:this.scanA},uScanB:{value:this.scanB},uRipple:{value:this.rippleValues}}}),this.quad=new $(new X(2,2),this.material),this.scene.add(this.quad);const f=i.domElement;this.resize(f.clientWidth||1,f.clientHeight||1)}sst(e){const i=Math.min(1,Math.max(0,e));return i*i*(3-2*i)}kickFlash(e){this.flash=Math.min(ke,this.flash+e)}kickSpark(){this.spark=Math.min(Me,this.spark+Ce),this.sparkSeed++}startScan(e,i,t){let a=this.scanSlots.findIndex(o=>!o.active);if(a<0){a=0;let o=this.scanSlots[0].age;for(let h=1;h<this.scanSlots.length;h++)this.scanSlots[h].age>o&&(o=this.scanSlots[h].age,a=h)}const s=this.scanSlots[a];s.active=!0,s.age=0;const r=this.forceMisAlways||this.rand()<t.misProb;s.mislabel=r,this.scanA[a].set(e,i,0,1),this.scanB[a].set(_e+this.rand()*Oe,r?1:0,this.rand(),0)}fireScan(e){const i=this.cover,t=this.material.uniforms.uZoom.value;let a=0,s=0;const r=e.survivorFocus>.5;for(let l=0;l<4&&(a=(this.rand()-.5)*.85,s=(this.rand()-.5)*.85,!(!r||Math.hypot(a,s)>.3));l++);let o=.5+this.pan.x+a*i.x/t,h=.5+this.pan.y+s*i.y/t;o-=Math.floor(o),h-=Math.floor(h),this.startScan(o,h,e)}scheduleScans(e,i,t){const a=Math.max(0,i)/60;if(!(a<=0))for(this.scanTimeToNext-=e;this.scanTimeToNext<=0;){this.fireScan(t),this.kickFlash(be);const s=Math.max(1e-6,this.rand());this.scanTimeToNext+=-Math.log(s)/a}}ageScans(e,i){for(let t=0;t<this.scanSlots.length;t++){const a=this.scanSlots[t];if(!a.active)continue;const s=a.age;a.age+=e;const r=a.age;if(this.scanA[t].z=r,s<T&&r>=T&&(this.classified+=Le),r>=Pe)a.active=!1,this.scanA[t].w=0,this.field.stamps[t].w=0;else{const o=this.scanB[t].x,h=r>=Ie&&r<T;this.field.stamps[t].set(this.scanA[t].x,this.scanA[t].y,o/i.commFreq,h?i.scanDrain:0)}}}scriptedMassScan(){this.pendingBurst=this.stampSlotCount,this.burstTimer=0,this.startWave(),this.kickFlash(M)}scriptedDrop(){this.kickFlash(M),this.gridSlam=Ue,this.startWave()}startWave(){this.waveCx=this.rand(),this.waveCy=this.rand(),this.waveActive=!0,this.waveAge=0}scheduleWaves(e,i){if(this.waveActive)if(this.waveAge+=e,this.waveAge>=F)this.waveActive=!1,this.field.wave.w=0;else{const a=this.sst(this.waveAge/F);this.field.wave.set(this.waveCx,this.waveCy,a*Ge,Ne*(1-this.waveAge/F))}const t=Math.max(0,i)/60;if(!(t<=0))for(this.waveTimeToNext-=e;this.waveTimeToNext<=0;){this.startWave();const a=Math.max(1e-6,this.rand());this.waveTimeToNext+=-Math.log(a)/t}}activatePoke(e,i){let t=this.pokeSlots.findIndex(s=>!s.active);t<0&&(t=0);const a=this.pokeSlots[t];a.active=!0,a.age=0,this.field.pokes[t].set(e,i,Ye,Xe)}updatePokeAges(e){for(let i=0;i<this.pokeSlots.length;i++){const t=this.pokeSlots[i];t.active&&(t.age+=e,t.age>=Ke&&(t.active=!1,this.field.pokes[i].w=0))}}activateRipple(e,i){let t=this.rippleSlots.findIndex(s=>!s.active);t<0&&(t=0);const a=this.rippleSlots[t];a.active=!0,a.age=0,this.rippleValues[t].set(e-Math.floor(e),i-Math.floor(i),0,1)}updateRippleAges(e){for(let i=0;i<this.rippleSlots.length;i++){const t=this.rippleSlots[i];t.active&&(t.age+=e,t.age>=Fe?(t.active=!1,this.rippleValues[i].w=0):this.rippleValues[i].z=t.age)}}warmup(e,i){this.field.clearField(),this.field.setActParams(e);const t=this.pinnedClassified??e.classifiedFloor;this.field.seedField(t,e.commFreq,e.machineOrder),this.classified=t;for(let a=0;a<i;a++)this.scheduleScans(k,e.scanRate,e),this.ageScans(k,e),this.field.step(k,1)}update(e,i){const t=ge(i.time),a=t.actIndex===3||t.actIndex===4?m[t.actIndex]:t.params;this.lastDt=e,this.firstUpdate&&(this.firstUpdate=!1,this.warmup(a,se)),this.lastSongTime>=0&&i.time<this.lastSongTime-10&&this.warmup(a,oe),this.lastSongTime>=0&&i.time-this.lastSongTime>=0&&i.time-this.lastSongTime<.5&&(this.lastSongTime<N&&i.time>=N&&this.scriptedMassScan(),this.lastSongTime<U&&i.time>=U&&this.scriptedDrop(),this.lastSongTime<z&&i.time>=z&&this.kickFlash(M),this.lastSongTime<V&&i.time>=V&&(this.flickerEnv=1)),this.lastSongTime=i.time;const s=Math.min(1,e*8);this.bassE+=(i.bass-this.bassE)*s,this.midE+=(i.mid-this.midE)*s,this.highE+=(i.high-this.highE)*s;const r=Math.min(1,e*1.5);if(this.bassSlowE+=(i.bass-this.bassSlowE)*r,this.highSlowE+=(i.high-this.highSlowE)*r,this.onsetCooldown-=e,this.onsetCooldown<=0&&this.bassE-this.bassSlowE>Se&&(a.scanRate>.5&&this.fireScan(a),this.kickFlash(H),t.actIndex===4&&!this.waveActive&&this.startWave(),this.onsetCooldown=we),this.highOnsetCooldown-=e,this.highOnsetCooldown<=0&&this.highE-this.highSlowE>xe&&(this.kickSpark(),this.highOnsetCooldown=ye),this.forceSparkAlways&&(this.sparkDebugTimer-=e,this.sparkDebugTimer<=0&&(this.kickSpark(),this.sparkDebugTimer=Te)),this.spark*=Math.exp(-7*e),this.forceScanAlways&&(this.scanDebugTimer-=e,this.scanDebugTimer<=0&&(this.fireScan(a),this.scanDebugTimer=He)),this.scheduleScans(e,a.scanRate,a),this.scheduleWaves(e,a.waveRate),this.forceWaveAlways&&(this.waveDebugTimer-=e,this.waveDebugTimer<=0&&(this.startWave(),this.waveDebugTimer=3)),this.pendingBurst>0)for(this.burstTimer-=e;this.burstTimer<=0&&this.pendingBurst>0;)this.fireScan(a),this.pendingBurst--,this.burstTimer+=.18;this.pinnedClassified!==null?this.classified=this.pinnedClassified:this.classified=Math.max(this.classified,a.classifiedFloor),this.ageScans(e,a),this.updatePokeAges(e),this.updateRippleAges(e),this.classified=Math.min(1,this.classified),this.pinnedClassified!==null&&(this.classified=this.pinnedClassified),this.flash*=Math.exp(-3.4*e),this.gridSlam*=Math.exp(-2.5*e),this.forceFlickerAlways?this.flickerEnv=1:this.flickerEnv*=Math.exp(-.6*e),this.field.setVitalityMod(1+this.bassE*.5),this.field.setActParams(a);let o;if(t.actIndex===0){const n=u[1]-u[0],d=t.localT*n,S=this.sst(Math.min(1,d/ze)),D=W+(m[0].zoom-W)*S;o=D+(m[1].zoom-D)*t.blend}else if(t.actIndex===2)o=m[2].zoom;else if(t.actIndex===3){const n=u[4]-u[3],d=t.localT*n,S=this.sst(Math.min(1,d/Ve));o=m[2].zoom+(m[3].zoom-m[2].zoom)*S}else if(t.actIndex===4){const n=u[5]-u[4],d=t.localT*n;d<q?o=m[3].zoom+(m[4].zoom-m[3].zoom)*this.sst(d/q):o=a.zoom}else o=a.zoom;const h=We*(1-.7*a.survivorFocus);o*=1+h*Math.sin(i.time*qe+this.breathPhase);const l=this.material.uniforms;l.uTime.value+=e,l.uZoom.value=o,l.uCommFreq.value=a.commFreq,l.uChurn.value=a.churn,l.uChatter.value=a.chatterRate*(1+this.midE*.8),l.uWarmth.value=a.warmth,l.uSparkle.value=this.highE,l.uGlyphKick.value=this.spark,l.uGlyphSeed.value=this.sparkSeed,l.uEnergy.value=fe(i.time).energy,l.uFlash.value=this.flash,l.uClassified.value=this.classified,l.uDesat.value=Math.min(1,this.classified*.6),l.uMachineFrac.value=a.machineFrac,l.uMachineOrder.value=a.machineOrder,l.uGridStrength.value=a.gridStrength,l.uGridFine.value=a.gridFine,l.uGlyphDensity.value=a.glyphDensity,l.uHueSat.value=a.hueSat,l.uRustMix.value=a.rustMix,l.uInkPersist.value=a.inkPersist,l.uVignette.value=a.vignette,l.uMotes.value=a.motes,l.uGroundLight.value=a.groundLight,l.uSurvivorFocus.value=a.survivorFocus,l.uGridSlam.value=this.gridSlam,l.uFlicker.value=this.flickerEnv;const v=this.cover;if(this.held){if(e>1e-5){const n=Math.min(1,e*Be),d=Math.min(w,Math.max(-w,this.dragDx/e)),S=Math.min(w,Math.max(-w,this.dragDy/e));this.velX+=(d-this.velX)*n,this.velY+=(S-this.velY)*n}this.dragDx=0,this.dragDy=0}else if(this.velX!==0||this.velY!==0){this.pan.x+=this.velX*v.x/o*e,this.pan.y+=this.velY*v.y/o*e;const n=Math.exp(-2.5*e);this.velX*=n,this.velY*=n,Math.abs(this.velX)<B&&(this.velX=0),Math.abs(this.velY)<B&&(this.velY=0)}const f=Math.hypot(this.pan.x,this.pan.y);f>A&&(this.pan.x*=A/f,this.pan.y*=A/f,this.velX=0,this.velY=0)}pointer(e){const i=this.material.uniforms.uZoom.value,t=this.cover;if(e.type==="down"){this.held=!0,this.dragDx=0,this.dragDy=0,this.velX=0,this.velY=0;const a=(e.x-.5)*t.x/i+.5+this.pan.x,s=(e.y-.5)*t.y/i+.5+this.pan.y,r=a-Math.floor(a),o=s-Math.floor(s);this.activatePoke(r,o),this.activateRipple(r,o),this.kickFlash(H);return}if(e.type==="move"){if(!this.held)return;this.pan.x+=e.dx*t.x/i,this.pan.y+=e.dy*t.y/i,this.dragDx+=e.dx,this.dragDy+=e.dy;return}if(e.type==="up"){this.held=!1;return}this.held=!1,this.velX=0,this.velY=0,this.dragDx=0,this.dragDy=0}render(){this.field.step(this.lastDt,this.stepsPerFrame),this.material.uniforms.uField.value=this.field.texture,this.renderer.setRenderTarget(null),this.renderer.render(this.scene,this.camera)}resize(e,i){if(!this.material||e<=0||i<=0)return;const t=Math.min(3.5,Math.max(.28,e/i));t>=1?this.cover.set(t,1):this.cover.set(1,1/t),this.material.uniforms.uCover.value.copy(this.cover)}dispose(){this.field.dispose(),this.material.dispose(),this.quad.geometry.dispose(),this.renderer.setRenderTarget(null)}}const je={default:()=>new $e},Qe=je.default;export{Qe as default};
//# sourceMappingURL=index-1EL258Iq.js.map
