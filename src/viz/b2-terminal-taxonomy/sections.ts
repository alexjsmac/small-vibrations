...
export interface ActParams {
  ...
  aura: number;
  /** 0..1 beat-synced colour pops — on each bass onset a different hash-picked subset of specimens flashes back to full vivid colour, breaking the monochrome (the climax's vibrancy channel). */
  beatPop: number;
...
export const ACTS: ActParams[] = [
  { // 1. Thriving field — the living patchwork at full vibrancy; no machine
    ...
    classifyPressure: 0, waveRate: 0, linkRate: 0, runnerRate: 0, gridLife: 0.45, fxAmount: 0.7, aura: 0, beatPop: 0, eventVivid: 0,
  ...
  { // 2. First scans — a faint machine grid fades in; sparse reticle scans
    ...
    classifyPressure: 0, waveRate: 0, linkRate: 0, runnerRate: 0, gridLife: 0.7, fxAmount: 0.8, aura: 0, beatPop: 0.25, eventVivid: 0.3,
  ...
  { // 3. Accelerating catalogue — scan rate climbs, drained/labeled patches
    ...
    classifyPressure: 0, waveRate: 0, linkRate: 2, runnerRate: 4, gridLife: 0.7, fxAmount: 0.6, aura: 0, beatPop: 0.4, eventVivid: 0.5,
  ...
  { // 4. Last unclassified — restraint + scale shift: deep zoom onto the one
    ...
    classifyPressure: 0, waveRate: 0, linkRate: 0, runnerRate: 0, gridLife: 0.3, fxAmount: 0.5, aura: 1.0, beatPop: 0.3, eventVivid: 0.4,
  ...
  { // 5. Total classification — THE drop at t=232: grid slams to full
    ...
    classifyPressure: 0.35, waveRate: 10, linkRate: 14, runnerRate: 22, gridLife: 1.0, fxAmount: 0.35, aura: 0, beatPop: 1.0, eventVivid: 1.0,
  ...
  { // 6. Residue — power-down at t=316; the field bleaches toward pale bone
    ...
    scanRate: 0, scanDrain: 0, misProb: 0,
    classifyPressure: 0, waveRate: 0, linkRate: 0, runnerRate: 0, gridLife: 0.3, fxAmount: 0.5, aura: 0, beatPop: 0.15, eventVivid: 0.2,
